    ...
    internal class TaintConfiguration
    {
            ...
            where T : ITaintedDataInfo
        {
            ...
            else
            {
                ...
                return new TaintedDataSymbolMap<T>(WellKnownTypeProvider, Enumerable.Empty<T>());
            }
        }
