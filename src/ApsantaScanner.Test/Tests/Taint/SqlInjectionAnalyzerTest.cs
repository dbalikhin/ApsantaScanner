...
namespace ApsantaScanner.Test.Tests.Taint
{
    using System;
    using System.Collections.Generic;
    ...
    using ApsantaScanner.Test.Tests.Config;
...
{{
    ...
    {{
        ...
        {{
            void DoInternalStuffLocal(string internalStuffLocalInput)
            {{
                var io2 = 10;
                var sql = io2.ToString() + internalStuffLocalInput;
            ...
            var oo2 = oo1 + 3;
            if (stuffInput != null)
                DoInternalStuffLocal(stuffInput);
        }}
